...
┗━━━━━﷽━━━━━┛
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Authur       \x1b[92;1m=>         \x1b[93;1m MRS-Shipon
\x1b[93;1m Whatsp       \x1b[92;1m=>        \x1b[93;1m01773276144
\x1b[93;1m Github       \x1b[92;1m=>         \x1b[93;1m Shipon
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #MR-GREEN
	...
	if farhan in ['1','01']:
		...
		os.system("xdg-open https://youtu.be/not found ")
		exit()
	else:
		os.system("https://youtu.be/not found ")
		exit()
